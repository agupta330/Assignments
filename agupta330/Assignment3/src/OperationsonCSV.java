	...
	public static void main(String args[]) throws IOException
	{
		...
		case 1:
			...
			case 1:
				...
				try 
				{
					j.insertStringInFile(infile, idno, id,firstname,lastname,age,email,country,ipaddress,order,color);
			    }
			...
			case 2:
				...
				try 
				{
				    ...
				    j.insertStringInFile2(infile, idno, id,firstname,lastname,age,email,country,ipaddress,order,color);
			    }
			...
			case 3:
				...
				try 
				{				
				    j.insertStringInFile1(infile, lineno, id,firstname,lastname,age,email,country,ipaddress,order,color);
			    }
				catch (Exception e) 
				{
				   e.printStackTrace();
